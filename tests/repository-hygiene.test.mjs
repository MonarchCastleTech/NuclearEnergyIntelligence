...
const methodologyEvidence = ["README.md","src/"];
const quickStartCommands = ["npm ci","npm run dev"];
const architectureIdentifiers = ["src/","public/"];
const thirdPartyExclusions = ["nuclear and geopolitical source datasets and reports","logos, maps, trademarks, screenshots, and external assets"];
...
test("MonarchCastleTech/NuclearEnergyIntelligence keeps every managed image local and ships a valid social preview", () => {
...
test("MonarchCastleTech/NuclearEnergyIntelligence documents citation, rights, and HTTPS policy", () => {
